            ...
            <Container>
               <div className="flex-1 max-w-[500px]">
                ...
                <p className="text-white text-xl max-w-[408px] mb-8">
                    Todas as operações que você precisa em um só lugar. Simples, completo e 
                    feito pra você
                </p>

                <div className="flex gap-4 mb-24">
                    <button>
                        <Image src={ImgAppleStore} alt="logo apple" />
                        <Image src={ImgGooglePlay} alt="logo apple" />
                    </button>
                </div>
 
                <button className="flex items-center gap-3">
                    <Image src={Arrowdown} alt="Icone seta para baixo" />
                    <span className="text-white text-sm font-bold">Continue explorando</span>
                </button>

               </div>

               <Image src={Woman} alt="Mulher" className="mr-[-41px] "/>
            </Container>
        </section>
    )
}